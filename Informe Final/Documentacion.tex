...
\begin{titlepage}
	...
	\begin{figure}[H]
		\begin{minipage}[b]{0.4\textwidth}
			\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{Extras/logoUNT}
		\end{minipage}
		\hfill
		\begin{minipage}[b]{0.4\textwidth}
			\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{Extras/logoFACET}
		\end{minipage}
	\end{figure}
...
\input{Capitulo8.tex}
\input{Capitulo9.tex}
\input{Capitulos/Anexo/Anexo.tex}
