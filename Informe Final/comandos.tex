...
\newcommand{\activityDiagram}[2]{
	\begin{figure}[H]
		\centering
		\includegraphics[angle=90,width=\textwidth,height=0.95\textheight,keepaspectratio]{DiagramasActividad/DiagramaDeActividad/#1}
		\caption{#2}
	\label{fig:#1}
	\end{figure}
}
...
\newcommand{\stateDiagram}[2]{
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{DiagramasEstado/DiagramaDeEstado/#1}
		\caption{#2}
	\label{fig:#1}
	\end{figure}
}
