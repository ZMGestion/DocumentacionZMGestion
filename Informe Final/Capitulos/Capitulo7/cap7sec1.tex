...
\paragraph\indent
Para realizar este test se utilizaron distintos conjuntos de datos, de manera tal que se atraviesen todas las bifuraciones del código. Los resultados de este test fueron exitosos. 

\paragraph\indent
Existe una herramienta para realizar tests automatizados que viene incorporado con Golang, el paquete test.
