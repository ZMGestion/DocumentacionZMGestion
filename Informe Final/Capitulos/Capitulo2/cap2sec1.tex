	...
	\subsection{Catálogo de requisitos del sistema}
		...
		\subsubsection{Descripción general}
			\paragraph\indent
				...
				\begin{itemize}
					%En edición, pendiente, cancelada, en prodducccin, finalizada, verificada
					...
					\item \item \textbf{En revisión:} Cuando se necesita que un administrador revise una venta ya que una linea de producto perteneciente a la venta no tiene el precio actual.
				...
				\begin{itemize}
					...
					\item \textbf{Pendiente de producción:} Cuando un administrador seleccionó la linea para ser producida.
					\item \textbf{En producción:} Cuando una linea de producto se encuentra en producción.
