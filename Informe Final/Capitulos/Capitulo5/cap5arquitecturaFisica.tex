...
\paragraph\indent
La arquitectura Cliente-Servidor-Internet es un modelo de aplicación distribuida en el que las tareas se reparten entre los servidores, que proveen de recursos o servicios, y los clientes, que demandan por estos recursos y servicios a través de Internet. Si un cliente realiza peticiones a otro programa es el servidor quien le da una respuesta. Para implementar esta arquitectura se utilizó el patrón MVC mencionado anteriormente.
