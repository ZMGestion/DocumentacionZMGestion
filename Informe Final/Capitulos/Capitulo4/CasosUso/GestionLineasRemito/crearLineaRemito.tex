...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion muestra un formulario para que el vendedor seleccione un producto, tela, lustre e indique la cantidad del mismo. Indicando que el producto y la cantidad son obligatorios.}
    \addCaseUseStep{El vendedor selecciona producto, tela, lustre y la cantidad que desea producir.}
...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
    ...
    \caseUseRow{}
    \newAlternative{A2: El producto, tela y lustre indicado ya se encuentra en el remito.}{3} %Flujo alternativo A2.
