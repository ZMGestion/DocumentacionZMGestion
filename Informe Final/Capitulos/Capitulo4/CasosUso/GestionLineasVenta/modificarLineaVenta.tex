...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
	...
	\newAlternative{A1: La venta a la cual pertenece la linea no se encuentra en estado "En edición".}{3} %Flujo alternativo A1.
	\caseUseRow{La secuencia A1 comienza luego del punto 3 del escenario principal.} %¡Indicar número paso!
    \alternativeRow{ZMGestion muestra un mensaje de error indicando que no se puede modificar la linea de venta ya que la venta no se encuentra en estado "En edición".}
