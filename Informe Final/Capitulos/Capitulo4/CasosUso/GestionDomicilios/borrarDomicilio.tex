...
\renewcommand{\caseUseName}{CU63 - Borrar domicilio} %{\CUcammelCase - Title}
...
\renewcommand{\caseUsePreconditions}{
	\caseUseRow{Haber realizado con éxito el CU61 (Listar domicilios) para un cliente.} %Precondiciones
}
