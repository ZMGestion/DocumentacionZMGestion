...
\renewcommand{\caseUseName}{CU95 - Borrar orden de producción} %{\CUcammelCase - Title}
...
\renewcommand{\caseUsePreconditions}{\caseUseRow{Haber realizado con éxito el CU92\ (Buscar avanzado órdenes de producción).} %Precondiciones
}
