...
\renewcommand{\caseUseSummary}{Este caso de uso permite a un fabricante de ZMGestion listar las lineas de órdenes de producción de una orden de producción determinada.} %Resumen
...
\renewcommand{\caseUseScene}{ %Escenario principal
    \addCaseUseStep{El fabricante indica la orden de producción a la cual desea listar sus lineas de orden de producción.}
    \addCaseUseStep{ZMGestion lista las lineas de orden de producción existentes de la orden de producción seleccionada.}
}
