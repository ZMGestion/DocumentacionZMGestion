...
\renewcommand{\caseUseName}{CU91 - Crear orden de producción} %{\CUcammelCase - Title}
...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
    ...
    \alternativeRow{ZMGestion muestra un mensaje de error indicando que no se pueden agregar dos líneas idénticas a la orden de producción.}
