...
\renewcommand{\caseUseName}{\CUcrearLineaPresupuesto\ - Modificar linea de presupuesto} %{\CUcammelCase - Title}
...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion modifica la linea de presupuesto con el valor de los campos producto, tela, lustre, precio unitario y cantidad solicitada ingresados por el usuario.}
}
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
	...
	\newAlternative{A3: El producto seleccionado es de tipo "Sin proceso de producción" y el vendedor a indicado una tela o lustre distinto a "Virgen" o "No lleva".}{3} %Flujo alternativo A3.
    \caseUseRow{La secuencia A3 comienza luego del punto 3 del escenario principal.}%¡Indicar número paso!
    \alternativeRow{ZMGestion muestra un mensaje de error indicando que el producto ingresado no es válido.}
    \caseUseRow{El escenario vuelve al punto 2.}
    \caseUseRow{}

    \newAlternative{A4: El vendedor no cuenta con los permisos necesarios para modificar el precio.}{5} %Flujo alternativo A4.
