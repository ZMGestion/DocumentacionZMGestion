...
\renewcommand{\caseUseName}{CU74 - Borrar linea de presupuesto} %{\CUcammelCase - Title}
...
\renewcommand{\caseUsePreconditions}{
	\caseUseRow{Haber ejecutado con éxito el CU71 (Listar lineas de presupuesto)} %Precondiciones
}
