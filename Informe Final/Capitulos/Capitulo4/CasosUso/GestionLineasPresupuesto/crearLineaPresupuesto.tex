...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
	...
	\newAlternative{A2: El producto seleccionado es de tipo "Sin proceso de producción" y el vendedor a indicado una tela o lustre distinto a "Virgen" o "No lleva".}{3} %Flujo alternativo A2.
