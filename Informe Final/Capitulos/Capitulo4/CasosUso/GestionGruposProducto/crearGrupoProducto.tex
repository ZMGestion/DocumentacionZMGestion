...
\renewcommand{\caseUseName}{\CUcrearGrupoProducto - Crear grupo de productos} %{\CUcammelCase - Title}
...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion muestra un formulario para que el administrador ingrese el nombre del grupo de productos.}
    \addCaseUseStep{El administrador ingresa un nombre de grupo de productos.}
