...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion muetsra un formulario autocompletado con los datos de la tela seleccionada para que el administrador modifique: nombre y precio por metro.}
