...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion muestra un formulario para que el administrador ingrese el nombre de la tela y el precio por metro. Indicando que todos los campos son obligatorios.}
