...
\renewcommand{\caseUseName}{CU78 - Modificar venta} %{\CUcammelCase - Title}
...
\renewcommand{\caseUsePreconditions}{
	\caseUseRow{Haber realizado con éxito el CU76\ (Buscar avanzado ventas).} %Precondiciones
}
...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{Se ejecuta el \CUlistarLineasVenta\ (Listar líneas de venta) para la venta seleccionada.}%4
    \addCaseUseStep{Si el vendedor desea modificar una linea, ejecuta el CU85\ (Modificar linea de venta), si desea borrar una linea ejecuta el CU86\ (Borrar linea de venta) y si desea agrear una linea ejecuta el CU84\ (Crear linea de venta).}%5
...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
    ...
    \caseUseRow{El escenario vuelve al punto 1.}
    \caseUseRow{}
    \newAlternative{A4: La venta no posee ninguna linea de venta.}{4} %Flujo alternativo A3.
