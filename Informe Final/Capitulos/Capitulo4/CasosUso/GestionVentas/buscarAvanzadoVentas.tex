...
\renewcommand{\caseUseName}{\CUbuscarAvanzadoPresupuestos - Buscar avanzado ventas} %{\CUcammelCase - Title}
...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion realiza la busqueda por cliente, producto, tela, lustre y estado de la venta.}
