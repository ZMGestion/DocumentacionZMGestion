...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
    ...
    \newAlternative{A2: El administrador ha dejado un campo obligatorio vacio.}{3} %Flujo alternativo A1.
    ...
    \alternativeRow{ZMGestion muestra un mensaje de error informando que la cantidad de tela necesaria ingresada es invalida.}
    \caseUseRow{El escenario vuelve al punto 2.}
    \caseUseRow{}
