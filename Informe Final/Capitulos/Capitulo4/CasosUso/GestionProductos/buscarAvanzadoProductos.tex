...
\renewcommand{\caseUseSummary}{Este caso de uso permite a los usuarios buscar productos a partir de una cadena de búsqueda.} %Resumen
\renewcommand{\caseUsePeople}{Usuarios: quiere encontrar un producto existente en el sistema.} %Actor: Meta
...
\renewcommand{\caseUseScene}{ %Escenario principal
    \addCaseUseStep{ El usuario accede a la pantalla para realizar la búsqueda de productos.}
    \addCaseUseStep{ZMGestion muestra un formulario para que el usuario ingrese una cadena de búsqueda, elegir el grupo y categoría y tambien seleccionar si desea buscar productos dados de baja.}
    \addCaseUseStep{El usuario completa los campos solicitados.}
