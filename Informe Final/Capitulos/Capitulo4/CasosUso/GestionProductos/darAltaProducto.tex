...
\renewcommand{\caseUseName}{CU16 - Dar de alta producto} %{\CUcammelCase - Title}
...
\renewcommand{\caseUsePreconditions}{
	\caseUseRow{Haber realizado con éxito el CU14 (Buscar avanzado productos).} %Precondiciones
}
