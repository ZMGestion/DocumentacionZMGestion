...
\renewcommand{\caseUseScene}{ %Escenario principal
    \addCaseUseStep{El usuario indica el producto que desea dar de baja.}
    \addCaseUseStep{ZMGestion cambia el estado del producto a baja y muestra un mensaje indicando que la operación se realizo con éxito.}
}
