...
\renewcommand{\caseUseName}{CU7 - Modificar empleado} %{\CUcammelCase - Title}
...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
    ...
    \caseUseRow{}
    \newAlternative{A5: El usuario ha dejado un campo requerido vacío.}{3} %Flujo alternativo A3.
