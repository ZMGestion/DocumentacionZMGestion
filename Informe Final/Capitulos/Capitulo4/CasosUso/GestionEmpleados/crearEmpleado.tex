...
\renewcommand{\caseUseName}{\CUcrearEmpleado - Crear empleado} %{\CUcammelCase - Title}
...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion muestra un formulario para que el usuario ingrese: Nombres, apellidos, correo electrónico, número de teléfono, nombre de usuario, contraseña, fecha de inicio de actividad laboral, cantidad de hijos, estado civil, tipo de documento, documento, teléfono, fecha de nacimiento, rol del empleado que desea agregar y su ubicación en la cual desempeñara su tarea. Indicando que son requeridos todos los campos.}
...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
    ...
    \caseUseRow{El escenario vuelve al punto 2.}
    \caseUseRow{}
    \newAlternative{A4: El usuario ha dejado un campo requerido vacio.}{3} %Flujo alternativo A3.
