...
\renewcommand{\caseUseName}{CU05 - Dar de baja empleado} %{\CUcammelCase - Title}
...
\renewcommand{\caseUsePostconditions}{
	\caseUseRow{Se cierra la sesión del empleado que se está dando de baja.} %Postcondiciones
}
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestión cierra la sesión del usuario que se dió de baja.}
}
