...
\renewcommand{\caseUseName}{\CUlistarLineasPresupuesto - Listar lineas de presupuesto} %{\CUcammelCase - Title}

\renewcommand{\caseUseSummary}{Este caso de uso permite a un vendedor listar las lineas de presupuesto de un presupuesto determinado.} %Resumen
