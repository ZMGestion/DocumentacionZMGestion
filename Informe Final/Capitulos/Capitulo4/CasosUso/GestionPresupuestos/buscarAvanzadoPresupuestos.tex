...
\renewcommand{\caseUseName}{CU65 - Buscar avanzado presupuestos} %{\CUcammelCase - Title}
...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion realiza la búsqueda por cliente, producto, tela, lustre y estado del presupuesto.}
