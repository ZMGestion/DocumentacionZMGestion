...
\renewcommand{\caseUseSummary}{Este caso de uso permite a un vendedor enviar un presupuesto por email.} %Resumen
...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion envia el presupuesto al correo electrónico del cliente al que se le realizó el presupuesto seleccionado.}
}
