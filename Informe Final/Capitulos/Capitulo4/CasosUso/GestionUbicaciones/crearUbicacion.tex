...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion muestra un formulario para que el administrador ingrese el nombre de la ubicación, la calle y el número, el código postal y seleccione ciudad, provincia y país. Inidicando que todos los campos son obligatorios.}
