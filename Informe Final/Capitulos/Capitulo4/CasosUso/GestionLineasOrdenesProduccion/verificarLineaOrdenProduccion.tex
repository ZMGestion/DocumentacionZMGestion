...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion pasa la línea de orden de producción al estado `Reservada' en caso de tener una venta asociada, caso contrario al estado de `Verificada'. ZMGestion muestra un mensaje indicando el éxito de la operación.}
}
