...
\renewcommand{\caseUseSummary}{Este caso de uso permite a un administrador de ZMGestion verificar que una línea de producción se encuentra finalizada.} %Resumen
\renewcommand{\caseUsePeople}{Administradores: quiere verificar que una línea de orden de producción esta finalizada.} %Actor: Meta
...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion pasa la línea de orden de producción al estado `Verificada' y muestra un mensaje indicando el éxito de la operación.}
}
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
	\newAlternative{A1: La línea de orden de producción no se encuentra en estado `En producción'.}{1} %Flujo alternativo A1.
