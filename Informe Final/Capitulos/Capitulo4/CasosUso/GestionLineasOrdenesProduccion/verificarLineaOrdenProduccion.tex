...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
	\newAlternative{A1: La línea de orden de producción no se encuentra en estado `En producción' y sus tareas no están todas finalizadas.}{1} %Flujo alternativoA1.
