...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion le muestra un formulario para que el administrador seleccione un producto, tela, lustre e indique la cantidad a producir de dicho producto.}
    \addCaseUseStep{El administrador selecciona producto, tela, lustre y la cantidad que desea producir.}
