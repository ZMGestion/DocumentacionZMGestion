...
\renewcommand{\caseUseName}{CU98 - Crear linea de orden de producción.} %{\CUcammelCase - Title}
...
\renewcommand{\caseUsePreconditions}{
	\caseUseRow{Estar ejecutando el CU91 (Crear orden de producción) o el CU93 (Modificar orden de producción).} %Precondiciones
}
\renewcommand{\caseUsePostconditions}{
	\caseUseRow{Si el producto, tela y lustre no pertenece a ningun producto final existente se ejecuta el CU25 (Crear producto final) con el producto, tela y lustre seleccionados.} %Postcondiciones
}
