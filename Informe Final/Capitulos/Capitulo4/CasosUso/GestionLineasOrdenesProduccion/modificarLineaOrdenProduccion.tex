...
\renewcommand{\caseUseName}{CU99 - Modificar línea de orden de producción} %{\CUcammelCase - Title}
...
\renewcommand{\alternativeCaseUse}{ %Flujos alternativos
    ...
    \newAlternative{A5: El administrador ha dejado un campo obligatorio vacío.}{3} %Flujo alternativo A1.
