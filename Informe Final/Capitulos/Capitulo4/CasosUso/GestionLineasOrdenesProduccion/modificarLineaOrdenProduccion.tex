...
\renewcommand{\caseUseScene}{ %Escenario principal
    ...
    \addCaseUseStep{ZMGestion muestra un formulario autocompletado con los datos de la linea de orden de producción seleccionada, producto, tela, lustre y cantidad a producirse.}
    \addCaseUseStep{El administrador modifica el producto, tela, lustre y cantidad a producirse.}
