\section{Modelización del sistema}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			%\itemCaseUse{darBajaComprobante}{Dar de baja comprobante}
			%\itemCaseUse{darAltaComprobante}{Dar de alta comprobante}
	...
	\subsection{Descripción textual de los casos de uso y diagramas de actividad}
		\begin{enumerate}
			...
			%GestionComprobantes
			%\input{Capitulos/Capitulo4/CasosUso/GestionComprobantes/crearComprobante.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionComprobantes/buscarAvanzadoComprobantes.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionComprobantes/darBajaComprobante.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionComprobantes/darAltaComprobante.tex}
