\section{Modelización del sistema}
	...
	\subsection{Descripción textual de los casos de uso y diagramas de actividad}
		\begin{enumerate}
			...
			%GestionFacturas
			%\input{Capitulos/Capitulo4/CasosUso/GestionFacturas/crearFactura.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionFacturas/buscarAvanzadoFacturas.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionFacturas/darBajaFactura.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionFacturas/darAltaFactura.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionFacturas/modificarFactura.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionFacturas/borrarFactura.tex}

			%GestionRecibos
			%\input{Capitulos/Capitulo4/CasosUso/GestionRecibos/crearRecibo.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionRecibos/buscarAvanzadoRecibos.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionRecibos/darBajaRecibo.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionRecibos/darAltaRecibo.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionRecibos/modificarRecibo.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionRecibos/borrarRecibo.tex}

			%GestionNotasCredito
			%\input{Capitulos/Capitulo4/CasosUso/GestionNotasCredito/crearNotaCredito.tex}
			%\input{Capitulos/Capitulo4/CasosUso/GestionNotasCredito/buscarAvanzadoNotasCredito.tex}
