\section{Modelización del sistema}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{DiagramaClases/Vistas/diagramaClases}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{DiagramaClases/Vistas/vistaSistema}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{DiagramaClases/Vistas/fichaTecnicaClases}
	...
	\stateDiagram{empleados}{Diagrama de transición de estados - Empleados}
	\stateDiagram{tareas}{Diagrama de transición de estados - Tareas}
	\stateDiagram{lineasProducto}{Diagrama de transición de estados - Lineas de producto}
	\stateDiagram{presupuestos}{Diagrama de transición de estados - Presupuestos}
	\stateDiagram{ventas}{Diagrama de transición de estados - Ventas}
	\stateDiagram{ordenesProduccion}{Diagrama de transición de estados - Órdenes de producción}
	\stateDiagram{remitos}{Diagrama de transición de estados - Remitos}

	\clearpage %salto de pagina
	\subsection{Diagramas de interacción}
	Solo se especificarán los diagramas de interacción más relevantes del sistema.

%	\begin{figure}[H]
%		\centering
%		\includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{DiagramasSecuencia/GestionUsuarios}
%		\caption{Diagrama de interacción - Gestión de usuarios}
%	\label{fig:Diagrama de interacción - Gestión de usuarios}
%	\end{figure}
